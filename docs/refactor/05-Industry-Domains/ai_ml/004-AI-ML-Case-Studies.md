...
- [ ] 新增2个端到端案例（分类/时序或NLP/CV）
- [ ] 每个案例补齐：业务→架构→代码→评估→经验
- [ ] 增补性能指标与基准测试（含表格与图）
- [ ] 与 Overview 文档的交叉引用与回链

## 案例模板

1) 背景与目标：业务痛点、KPI/非功能指标
2) 架构设计：数据流/模型流/服务流图示
3) 关键实现：Haskell/Rust/Lean 片段与选择理由
4) 实验与评估：数据集、指标、对比、消融
5) 生产化与风险：部署、监控、回滚、合规
6) 经验与复盘：踩坑、最佳实践、后续计划
